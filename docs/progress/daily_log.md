...
- chain_count系アイテム（1034, 1055）のテスト追加
- 先制スキル表示修正（`_diff_skill_state` で `has_item_first_strike` 検出）→ 4アイテム追加
- 条件判定問題の調査（1015 ファントムブレイズ、1022 タイダルスピア）
- 非決定的アイテムのテスト方針決定（1027, 1041, 1047）
- 復帰効果の別テスト作成（1005, 1030, 1054）
