...
主要な残りクリーチャー: アースズピリット、デュータイタン、ブラッドプリン、ドゥームデボラー、リーンタイタン、ギガンテリウム、スペクター、オーガロード
...
| 446 | ロックタイタン | バトル後ST-10 | バトル終了時 | base_up_ap -= 10 |
| 439 | リーンタイタン | バトル後MHP-10 | バトル終了時 | base_up_hp -= 10 |
...
| 439 | リーンタイタン | after_battle_permanent_change | on_battle_end | 🟢永続 | 🚧未実装 |
| 34 | バイロマンサー | 特殊処理（ID判定） | on_battle_end | 🟢永続 | ✅実装済み |

**永続バフ**: ID 35（バルキリー）、ID 227（ダスクドウェラー）、ID 34（バイロマンサー）、ID 446（ロックタイタン）、ID 439（リーンタイタン）
...
**最終更新**: 2025年10月29日（バイロマンサー、リビングアーマー、ブルガサリ実装完了）（v1.5）
