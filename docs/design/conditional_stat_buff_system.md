...
**バージョン**: 1.0  
**作成日**: 2025年10月26日  
**ステータス**: Phase 3 実装中（30体/38体 完了）  
**最終更新**: 2025年10月29日（バイロマンサー、リビングアーマー、ブルガサリ実装完了）
...
残りクリーチャー: ドゥームデボラー、スペクター、オーガロード
...
| ID | 名前 | effect_type | 永続性 |
|----|------|------------|---------|-------|----------||----|------|------------|---------|-------|----------|--|----|------|------------|---------|-------|----------||----|------|------------|---------|-------|----------|--|----|------|------------|---------|-------|----------|---|
| 321 | スペクター | random_stat | 🔵一時 | 🚧未実装 |
| 137 | ブラッドプリン | assist_mhp_absorption | 🟢永続 | ✅実装済み |
| 407 | オーガロード | tribe_placement_bonus | 🔵一時 | 🚧未実装 |
...
**最終更新**: 2025年10月29日（ブラッドプリン実装完了、援護システム統合、残り3体）（v1.8）
