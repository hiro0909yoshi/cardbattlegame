...
**バージョン**: 1.0  
**作成日**: 2025年10月26日  
**ステータス**: Phase 3 実装中（22体/38体 完了）  
**最終更新**: 2025年10月28日（ロックタイタン実装完了）
...
主要な残りクリーチャー: アースズピリット、デュータイタン、バイロマンサー、ブラッドプリン、ドゥームデボラー、リーンタイタン、ギガンテリウム、リビングアーマー、ブルガサリ、スペクター、オーガロード
...
- **実装済み**: 21体
  - Phase 3-A: 9体（常時補正、配置数比例、戦闘地条件）
  - Phase 3-B: 6体（防御時、領地数、クリーチャーカウント、隣接条件）
  - その他: 6体（破壊数、周回・ラウンド数、手札数）
- **未実装**: 17体
...
|----|------|------------|---------|-------|----------||----|------|------------|---------|-------|----------|--|----|------|------------|---------|-------|----------||----|------|------------|---------|-------|----------|--|----|------|------------|---------|-------|----------|-----|----|------|------------|---------|-------|----------|---|
| 35 | バルキリー | on_enemy_destroy_permanent | on_battle_win | 🟢永続 | 🚧未実装 |
| 227 | ダスクドウェラー | on_enemy_destroy_permanent | on_battle_win | 🟢永続 | 🚧未実装 |
| 323 | ソウルコレクター | destroy_count_multiplier | 毎バトル | 🔵一時 | 🚧未実装 |
...
| 34 | バイロマンサー | after_battle_permanent_change | on_battle_end | 🟢永続 | 🚧未実装 |
...
**最終更新**: 2025年10月28日（ロックタイタン実装完了）（v1.3）
