...
- [x] 1050: バインドウィップ - AP+30；攻撃成功時、敵に呪い"消沈"
...
- [x] 1067: ムーンシミター - AP+30；攻撃成功時、敵に呪い"免罪"
...
- [x] 1015: シャドウブレイズ - 術攻撃[ST40]；敵と同じクリーチャー配置時、術強化
- [x] 1024: スパークボール - 術攻撃[ST40]
- [x] 1030: ソウルレイ - 術攻撃[ST30]；復帰[手札]
- [x] 1035: チリングブラスト - 術攻撃[AP=水風自ドミニオ数×10]；術強化[火地]
- [x] 1037: ティアリングハロー - 術攻撃[ST30]；無以外使用時、術強化；アイテム破壊・盗み無効
- [x] 1047: ネクロプラズマ - 術攻撃[ST50]；変身[スケルトン]
- [x] 1049: バーニングロッド - 術攻撃[AP=火地自ドミニオ数×10]；術強化[水風]
