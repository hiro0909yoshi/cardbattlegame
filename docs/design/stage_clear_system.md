...
| コンポーネント | サイズ |
|----------------|--------|
| メニューボタン | 180x180px、半透明(0.7)、フォントサイズ96 |
| メニューパネル | 1200x1100px、画面中央より上に表示 |
| メニューボタン | 1040x240px、フォントサイズ96 |
| 降参ダイアログ | 900x500px、画面中央より上に表示 |
| ダイアログボタン | 320x120px、フォントサイズ48 |
