...
| 通行料無効 | `creature_toll_disable` | そのドミニオの通行料が0になる |
...
| 220 | スクリーマー | アルカナアーツ: 敵に地形効果無効 |
| 431 | ハイドビハインド | アルカナアーツ: 自に地形効果付与 |
...
| ID | 名前 | タイプ | 効果 |
|----|------|-------|------|
| 2032 | シニリティ | スペル | 対象ドミニオに戦闘後破壊呪い付与 |
...
| `battle_execution.gd` | 100EP移動、戦闘後破壊、スキル呪い付与 |
