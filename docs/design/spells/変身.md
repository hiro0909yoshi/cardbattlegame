...
## 概要
クリーチャーを別のクリーチャーに変身させる。装備アイテムと永続ボーナスは引き継ぐが、呪いは消える。変身後は必ずダウン状態になる。
...
|----|------|--------|------|----------------|
| 2049 | ターンウォール | 80MP | 対象クリーチャーを同属性の防御型に変える | 属性別固定 |
...
|----|------|------|--------|--------|----------|
| 20 | デスサイズ | 火 | G50 | マミー | 239 |
| 104 | アクアホーン | 水 | G30 | ミストウィング | 142 |
| 135 | ヒッポカンパス | 水 | G60 | ケルピー | 121 |
| 142 | ミストウィング | 水 | G30 | アクアホーン | 104 |
| 224 | スプラウトリング | 地 | G50 | オールドウィロウ | 5 |
| 236 | ブランチアーミー | 地 | G50 | マッドマン | 238 |
| 319 | シルフ | 風 | G60 | ガルーダ | 307 |
| 324 | ソードプリンセス | 風 | G60 | アームドプリンセス | 300 |
| 417 | シェイプシフター | 無 | G70 | 対象と同じ | (コピー) |
...
| 指定方法 | 説明 | 使用箇所 |
|----------|------|----------|
| `transform_to: ID` | 固定IDへ変身 | 秘術変身8体 |
| `transform_type: "copy_target"` | 選択対象と同じに | シェイプシフター |
| `transform_type: "same_element_defensive"` | 同属性防御型（属性別固定） | ターンウォール |
...
- 秘術システム: `docs/design/mystic_arts.md`
