...
堅牢は、スペルやアルカナアーツによる直接的なHP/MHP変更効果を無効化する能力。
この能力を持つクリーチャーは、HP変更系スペル/アルカナアーツの対象に選択できない。
...
|------|------|------|
| 地 | オドラデク | 加勢；堅牢 |
| 水 | アクアデューク | 加勢[水]；防具使用時、無効化[通常攻撃]；堅牢 |
| 水 | アンフィビアン | 戦闘地が水風の場合、AP+20；堅牢 |
| 風 | ソードプリンセス | 先制；堅牢；アルカナアーツ[60EP・アームドプリンセスに変身] |
...
| ファイル | 役割 |
|----------|------|
| scripts/spells/spell_hp_immune.gd | 堅牢判定クラス |
