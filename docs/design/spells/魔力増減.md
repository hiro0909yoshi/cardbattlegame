...
| ID | 名前 | 効果 | 状態 |
|----|------|------|------|
| 2004 | アセンブルカード | 手札に4属性あり → G500 | ✅ |
| 2007 | インシネレート | 破壊数×G20獲得、カウントリセット | ✅ |
| 2020 | ギフト | 順位×G50獲得 | ✅ |
| 2025 | クレアボヤンス | 敵スペルコスト合計×50%獲得 | ✅ |
| 2038 | スクイーズ | 敵カード破壊 + G150 | ✅ |
| 2044 | スピードペナルティ | (敵周回-自周回)×G100奪取 | ✅ |
| 2051 | チャージステップ | ダイス呪い + G50 | ✅ |
| 2062 | ドレインシジル | 秘術付与: 敵魔力10%奪取(G20) | ✅ |
| 2063 | ドレインマジック | 敵魔力30%奪取 | ✅ |
| 2069 | バウンティハント | 呪い: 武器で破壊時G300 | ✅ |
| 2082 | フラクション | 敵魔力30%奪取(自分より多い敵のみ) | ✅ |
| 2083 | ブラストトラップ | 土地呪い: 停止時魔力40%減+HP-20 | ✅ |
| 2109 | マナ | 周回数×G50獲得 | ✅ |
| 2118 | ランドトランス | 自領地放棄→価値×70%獲得 | ✅ |
| 2119 | ランドドレイン | 敵領地数×G30奪取 | ✅ |
| 2130 | レディビジョン | 全プレイヤー魔力平均化 | ✅ |
| 2131 | ロングライン | 4連続領地でG500、未達成→ドロー | ✅ |

### クリーチャー秘術（2個）

| ID | 名前 | 秘術効果 | 状態 |
|----|------|----------|------|
| 230 | ドワーフマイナー | 周回数×G30獲得 | ✅ |
| 413 | ゴールドトーテム | G200獲得 + 自壊 | ✅ |
