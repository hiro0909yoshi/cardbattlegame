...
防魔は**スペル/秘術の対象に選べなくなる**効果。ターゲット選択段階でフィルタリングされる。
...
| 2105 | マジックシェルター | 領地 | protection_wall | 永続 |
...
|-------------|----------|------|-----------|
| ドモビー(24) | 9022 | 自領地クリーチャー | spell_protection |
| パトロナス(336) | 9023 | セプター | spell_protection |

秘術定義は `data/spell_mystic.json` に追加済み。
