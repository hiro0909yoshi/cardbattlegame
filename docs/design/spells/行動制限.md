...
|----|------|------|-------------|
| 2067 | ライズアップ | 対象ドミニオに刻印"奮闘"（5R間） | `indomitable` |
...
奮闘スキル（元々持っている）と奮闘刻印（スペルで付与）を統合判定。
...
| `has_indomitable_curse(creature)` | 奮闘刻印判定（静的） |
...
| `scripts/spells/spell_curse.gd` | 刻印効果のルーティング |
