...
| 2007 | インシネレート | 破壊数×20EP獲得、カウントリセット | ✅ |
| 2020 | ギフト | 順位×50EP獲得 | ✅ |
| 2025 | クレアボヤンス | 敵スペルコスト合計×50%獲得 | ✅ |
| 2038 | スクイーズ | 敵カード破壊 + 150EP | ✅ |
| 2044 | スピードペナルティ | (敵周回-自周回)×100EP奪取 | ✅ |
| 2051 | チャージステップ | ダイス呪い + 50EP | ✅ |
| 2062 | ドレインシジル | 秘術付与: 敵EP10%奪取(20EP) | ✅ |
...
| ID | 名前 | 秘術効果 | 状態 |
|----|------|----------|------|
| 230 | ドワーフマイナー | 周回数×30EP獲得 | ✅ |
| 413 | ゴールドトーテム | 200EP獲得 + 自壊 | ✅ |
