...
| `scripts/game_flow/land_command_handler.gd` | コマンド実行時にロック/アンロック | 中 |
...
| `land_command_handler.gd` | 3箇所 | バトル実行 |
...
| `scripts/game_flow/land_command_handler.gd` | `open_land_command()`でアンロック ※既存 |
