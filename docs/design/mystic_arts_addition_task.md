...
### 3. 召喚系（place_creature / add_specific_card）

| 新ID | クリーチャー | 秘術名 | effect_type | 召喚先ID | 備考 |
|------|-------------|--------|-------------|----------|------|
| 9053 | ハイプクイーン | ハイプワーカー生成 | add_specific_card | 32 | 手札に追加 |
| 9054 | コンジャラー | バーアル召喚 | place_creature | 27 | 空地に配置+自己破壊 |
| 9055 | グーバクイーン | グーバ配置 | place_creature | 208 | 空地に配置 |
| 9056 | レジェンドファロス | スタチュー配置 | place_creature | 421 | 隣接に配置 |
