...
| 新ID | クリーチャー | 秘術名 | effect_type | 理由 |
|------|-------------|--------|-------------|------|
| 9057 | シェイプシフター | 対象と同じクリーチャーに変身 | transform (copy_target) | 動的変身先 |
| 9058 | ルーンアデプト | スペル借用 | use_hand_spell | 敵スペル使用 |
| 9059 | レムレース | クリーチャー交換 | swap_creature | 交換処理 |
