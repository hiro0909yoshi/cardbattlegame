...
「伝染」スキルを持つクリーチャーに呪いが付与された時、**同じ呪いを使用者の全ドミニオにも付与**し、**自身はダウン**するスキル。
...
```
1. プレイヤー1がプレイヤー2のエンチャントレス（伝染持ち）に「消沈」呪いを使用
2. エンチャントレスに刻印付与
3. 伝染発動:
   - プレイヤー1の全ドミニオクリーチャーに「消沈」呪いを付与
   - 結界を持つクリーチャーは対象外
4. エンチャントレスがダウン
```
...
```
1. プレイヤー1が自分のエンチャントレス（伝染持ち）に「暁光」呪いを使用
2. エンチャントレスに刻印付与
3. 伝染発動:
   - プレイヤー1の全ドミニオクリーチャー（エンチャントレス以外）に「暁光」呪いを付与
4. エンチャントレスがダウン
```
