...
| アイテム破壊[道具か巻物か加勢クリーチャー] | 道具、巻物、加勢クリーチャーのいずれか |

**注意**: 加勢クリーチャーは加勢スキルで装備されたクリーチャー

### 実装クリーチャー（3体）

| ID | 名前 | 属性 | AP/HP | スキル | 破壊対象 |
|----|------|------|-------|--------|---------|
| 313 | デビルアイ | 風 | 20/30 | アイテム破壊[道具] | 道具のみ |
| 116 | カイザーペンギン | 水 | 30/50 | アイテム破壊[道具か巻物か加勢クリーチャー] | 道具・巻物・加勢 |
| 220 | シルバンダッチェス | 地 | 50/50 | 加勢[地]；アイテム破壊[道具か巻物か加勢クリーチャー]；再生 | 道具・巻物・加勢 |
...
```json
{
  ...
  "name": "カイザーペンギン",
  "ability": "アイテム破壊",
  "ability_detail": "アイテム破壊[道具か巻物か加勢クリーチャー]",
  "ability_parsed": {
	"keywords": ["アイテム破壊"],
	"effects": [
	  {
		"effect_type": "destroy_item",
		"target_types": ["道具", "巻物", "加勢クリーチャー"],
		"triggers": ["before_battle"]
	  }
	]
  }
...
| ID | 名前 | 属性 | AP/HP | スキル |
|----|------|------|-------|--------|
| 226 | セージ | 地 | 20/30 | 加勢；アイテム破壊・盗み無効；強化術 |
...
```json
{
  ...
  "name": "セージ",
  "ability": "アイテム破壊・盗み無効",
  "ability_detail": "加勢；アイテム破壊・盗み無効；強化術",
  "ability_parsed": {
	"keywords": ["加勢", "強化術"],
	"effects": [
	  {
...
1. **沈黙は最優先**: ウォーロックディスク等が発動すると、アイテム破壊スキルも無効化される
...
2. **コスト効率**
   - 低コストクリーチャー（デビルアイ20/30、シーフ20/40）で高価なアイテムを無効化できる
...
加勢クリーチャーが装備扱いになる場合、アイテム破壊の対象に含める。
...
- [`docs/design/skills/support_skill.md`](support_skill.md) - 加勢スキル（未作成）
