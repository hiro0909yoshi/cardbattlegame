...
死亡時に特殊効果を発動するスキル。魔力獲得やカードドローなど、敗北してもプレイヤーに利益をもたらす。
...
**該当クリーチャー**:
- **コーンフォーク** (ID: 315): 道産[G200]
- **クリーピングコイン** (ID: 410): 道産[G100]
...
- ゴールドグース（アイテム）の遺産効果と同じタイミングで発動
- アイテムの遺産処理 → クリーチャーの遺産処理の順

### 復活との関係

- 死者復活スキルで復活した場合、遺産効果は発動しない
- 復活失敗後に撃破確定となった時点で遺産効果が発動
