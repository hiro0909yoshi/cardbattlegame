...
| 1030 | ソウルレイ | S | 巻物 | 術攻撃[ST30] | 手札 |
| 1054 | ブーメラン | S | 武器 | AP+|AP&20；HP+10 | 手札 |
...
|---|------|---------|-----|-----|-------|
| 314 | ケンタウロス | N | wind | 先制；帰還[ブック] | ブック（全アイテム） |
| 41 | フレイムデューク | R | fire | 先制；武器使用時、強化；帰還[ブック] | ブック（全アイテム） |

**特殊仕様**:
- 両者とも使用したアイテム**全て**をブックに戻す
- 帰還の汎用版
- フレイムデュークは強化も持つため、武器との相性が良い
