...
| ID | 名前 | コスト | 効果 | 実装状況 |
|----|------|--------|------|---------|
| 2029 | サドンインパクト | 100G | 対象レベル4ドミニオのレベルを1下げる | ✅ 完全実装 |

### 実装予定の密命カード

| ID | 名前 | コスト | 条件 | 成功効果 | 失敗効果 |
|----|------|--------|------|---------|---------|
| 2004 | アセンブルカード | 50G | 手札に火水風地がある | 500蓄魔 | カードを2枚引く |
| 2085 | フラットランド | 40G | レベル2ドミニオを5つ持つ | それらをレベル+1 | 復帰[ブック] |
| 2096 | ホームグラウンド | 50G | 属性違いのドミニオを4つ持つ | 合う属性に変化 | 復帰[ブック] |

**復帰[ブック]**: 既存の帰還スキル（`skill_item_return.gd`）を活用し、使用者のデッキのランダムな位置に戻る
...
- [ドミニオ変更スペル](../spells/ドミニオ変更.md) - サドンインパクトの詳細
