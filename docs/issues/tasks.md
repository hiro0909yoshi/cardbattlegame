...
### ✅ Phase 1-A 完全完了: ドミニオオーダーシステム（完了: 2025/10/16）
...
**Phase 1-A 完全完了**: レベルアップ・移動・交換の3つのドミニオオーダーが全て利用可能
...
- **地形変化コストシステム（1体）**
  ...
  - 無属性タイルの初期コスト100G対応
- **土地属性変更アルカナアーツ（3体）**
  - マカラ（ID:141）: 配置ドミニオを水に変える
  - サクヤ（ID:216）: 対象自ドミニオを地に変える
  - ストーンジゾウ（ID:423）: 対象ドミニオを無に変え自壊
- **土地変性・土地破壊システム（6体）**
