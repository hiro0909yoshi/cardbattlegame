...
func initialize(board_sys, land_cmd_handler):
	...
	dominio_command_handler = land_cmd_handler
...
func on_number_key_pressed(tile_index: int):
	...
	if dominio_command_handler and dominio_command_handler.is_active:
		dominio_command_handler.select_tile(tile_index)
